...
describe("Get Default options using defautOptions(options)",()=>{
    ...
    test("Checking Default option if data options are empty ",()=>{
        ...
        expect(DEFAULT_OPTIONS).toEqual({"disabledList": [], "lowerLimit": 2020, "showQuarters": true, "showWeeks": false, "upperLimit": 2021})

    })
})

// 24 Get Year Array from getYearList function
// describe('Get Year Array from getYearList function',()=>{
