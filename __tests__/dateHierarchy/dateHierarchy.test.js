...
describe('search for any data first time and after close search again for different data and close again with checking the adding to current selection it should merge our 1st and 2nd search result',()=>{
    test('For year',()=>{
        ...
        wrapper.find('Input').simulate('change',{target:{value:'2021'}})
        // console.log(wrapper.debug())
        // console.log(wrapper.find('.VS-Checkbox').at(1).props())
    ...
    test('For Weeks',()=>{
        ...
        //     if(wrapper.find('.VS-WeekRow .VS-Tooltip').at(i).text() === 'Week 1Week 1 Jan 2020'){
        //         console.log('in loop',wrapper.find('.VS-WeekRow .VS-Tooltip').at(i).text())
        //         // expect(wrapper.find('.VS-WeekRow .VS-Checkbox').at(i).props().checked).toEqual(1)
        //         // expect(wrapper.find('.VS-WeekRow .VS-Checkbox').at(i).props().checked).toEqual(1)
        //     }
    ...
    test('For Quaters',()=>{
        ...
        wrapper.find('.VS-Shape.VS-TextDark.VS-CloseIcon').at(2).simulate('click')
        // console.log(wrapper.debug())
        // console.log(wrapper.find('.VS-Checkbox-Container').at(8).text())
