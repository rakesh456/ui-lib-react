...
// 2. Buttons rendering default options without crashing
...
//3. Week component renders the week element correctly
...
//4. Month component renders the month correctly
...
// 15.Check date properly select or not when click of any day
...
describe('Check date properly select or not when click of any day', () => {
  ...
  test('Check When display format is DD/MM/YYYY then if click event happen then some date is got selected or not', () => {
    ...
    const options = {
      "displayFormat": "DD/MM/YYYY", "defaultDate": "30/01/2019", "iconAlignment": "left", "showErrorMessage": true, "dateStringAlignment": "left", "lowerLimit": "18/11/2018", "upperLimit": "18/11/2020", "validationMessages1": [{ "inValidFormat": "Invalid DOB" }, { "outsideRange": "" }], "isDisabled": false,
